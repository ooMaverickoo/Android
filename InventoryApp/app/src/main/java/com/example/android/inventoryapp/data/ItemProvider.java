...
public class ItemProvider extends ContentProvider {
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        if (values.containsKey(ItemContract.ItemEntry.COLUMN_ITEM_SUPPLIER)) {
            String sName = values.getAsString(ItemContract.ItemEntry.COLUMN_ITEM_SUPPLIER);
            if (sName == null) {
        ...
        if (values.containsKey(ItemContract.ItemEntry.COLUMN_ITEM_IMAGE)) {
            ...
            if (image == null) {
                throw new IllegalArgumentException("Product requires the image of the item");
            }
        }
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ItemContract.ItemEntry.COLUMN_ITEM_SUPPLIER)) {
            String sName = values.getAsString(ItemContract.ItemEntry.COLUMN_ITEM_SUPPLIER);
            if (sName == null) {
                throw new IllegalArgumentException("Item requires the supplier name");
            }
        }
        ...
        if (values.containsKey(ItemContract.ItemEntry.COLUMN_ITEM_SUPPLIER_EMAIL)) {
            String email = values.getAsString(ItemContract.ItemEntry.COLUMN_ITEM_SUPPLIER_EMAIL);
            if (email == null) {
                throw new IllegalArgumentException("Item requires the email of the supplier");
            }
        }
        ...
        if (values.containsKey(ItemContract.ItemEntry.COLUMN_ITEM_IMAGE)) {
            String image = values.getAsString(ItemContract.ItemEntry.COLUMN_ITEM_IMAGE);
            if (image == null) {
                throw new IllegalArgumentException("Item requires the image of the item");
            }
        }
